...
- Tests run **inside Docker only**: `docker-compose exec -w /app tinysiem pytest app/tests/ -v` (or a specific test with `::test_name`). Running `pytest` directly on the host will not work — `rtk` intercepts host Python/pytest invocations.
...
Run: `docker-compose exec -w /app tinysiem pytest app/tests/test_footprint.py -v`
...
Run: `docker-compose up --build -d && docker-compose exec -w /app tinysiem pytest app/tests/test_footprint.py -v`
Expected: PASS

- [ ] **Step 5: Run the full suite to confirm nothing else broke**

Run: `docker-compose exec -w /app tinysiem pytest app/tests/ -v`
...
Run: `docker-compose exec -w /app tinysiem pytest app/tests/test_startup_checks.py -v`
...
Run: `docker-compose up --build -d && docker-compose exec -w /app tinysiem pytest app/tests/ -v`
Expected: All PASS
...
Run: `docker-compose exec -w /app tinysiem pytest app/tests/test_users_schema_migration.py -v`
...
Run: `docker-compose exec -w /app tinysiem pytest app/tests/test_auth_lockout.py -v`
...
Run: `docker-compose exec -w /app tinysiem pytest app/tests/test_auth.py -v`
...
Run: `docker-compose exec -w /app tinysiem pytest app/tests/test_users_api.py -v -k short_password`
...
Run: `docker-compose exec -w /app tinysiem pytest app/tests/test_users_api.py -v`
...
Run: `docker-compose exec -w /app tinysiem pytest app/tests/test_ingest.py -v`
...
Run: `docker-compose exec -w /app tinysiem pytest app/tests/test_syslog_guardrails.py -v`
...
Run: `docker-compose exec -w /app tinysiem pytest app/tests/test_syslog_guardrails.py app/tests/test_syslog_listener.py -v`
Expected: PASS
...
Run: `docker-compose exec -w /app tinysiem pytest app/tests/test_cors.py -v`
...
Run: `docker-compose exec -w /app tinysiem pytest app/tests/test_generate_sbom.py -v`
...
Run: `docker-compose up --build -d && docker-compose exec -w /app tinysiem pytest app/tests/test_sbom.py -v`
Expected: PASS
...
Run: `docker-compose exec -w /app tinysiem pytest app/tests/test_csp.py -v`
...
Run: `docker-compose up --build -d && docker-compose exec -w /app tinysiem pytest app/tests/test_csp.py -v`
Expected: PASS
...
Run: `docker-compose exec -w /app tinysiem pytest app/tests/test_ui_fonts.py -v`
...
Run: `docker-compose exec -w /app tinysiem pytest app/tests/test_alert_suppression.py -v`
...
Run: `docker-compose up --build -d && docker-compose exec -w /app tinysiem pytest app/tests/test_alert_suppression.py -v`
Expected: PASS
...
Run: `docker-compose exec -w /app tinysiem pytest app/tests/test_security_feed.py -v`
...
Run: `docker-compose up --build -d && docker-compose exec -w /app tinysiem pytest app/tests/test_security_feed.py -v`
Expected: PASS
...
Run: `docker-compose exec -w /app tinysiem pytest app/tests/test_backup.py -v`
...
Run: `docker-compose up --build -d && docker-compose exec -w /app tinysiem pytest app/tests/test_backup.py -v`
Expected: PASS
